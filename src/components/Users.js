...
const Users = () => {
  ...
  return (
    <div className="p-4 sm:ml-64">
      ...
      <div className="max-w-full-xl mx-auto px-4 md:px-8 mt-20 ">
        ...
        <div className="mt-12 shadow-sm border rounded-lg overflow-x-auto">
          <table className="w-full table-auto text-sm text-left bg-cyan-100">
            ...
            <tbody className="text-gray-600 divide-y">
              {tableItems.map((item, idx) => (
                <tr key={idx} className="hover:bg-white text-black">
